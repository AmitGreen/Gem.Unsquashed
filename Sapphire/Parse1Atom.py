...
def gem():
    ...
    def parse1__parenthesized_expression__left_parenthesis(left_parenthesis):
        ...
        if not operator_1.is_end_of_expression:
            middle_1 = parse1_any_or_expression__left__operator(middle_1, operator_1)
        ...
        if not operator_2.is_end_of_expression:
            middle_2 = parse1_any_or_expression__left__operator(middle_2, operator_2)
        ...
        while 7 is 7:
            ...
            if not operator_7.is_end_of_expression:
                middle_3 = parse1_any_or_expression__left__operator(middle_3, operator_7)
